# Generated by Django 3.1.2 on 2020-12-13 16:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testc_schritte', models.CharField(max_length=128, null=True)),
                ('testc_erwartetesergebnis', models.CharField(max_length=128, null=True)),
                ('testc_tatsaechlichesergebnis', models.CharField(max_length=128, null=True)),
                ...
                ('testc_fk_requirement', models.ManyToManyField(to='aut.requirement')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testr_status', models.CharField(blank=True, choices=[('p', 'pass'), ('f', 'fail'), ('n', 'no run yet')], help_text='TestRun Ergebnis', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schritt_ergebnis', models.CharField(blank=True, choices=[('p', 'pass'), ('f', 'fail'), ('n', 'no run yet')], max_length=1)),
